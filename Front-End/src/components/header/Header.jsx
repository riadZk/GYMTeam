  ...
  return (
    ...
    >
      <nav className="md:flex justify-center md:justify-between w-full h-full items-center p-4 md:p-8 pt-5">
        ...
        <div
          className={`flex flex-col md:flex-row bg-dark md:bg-transparent justify-center w-full md:w-auto gap-4 items-center right-1 md:static fixed duration-500 ease-linear z-40 ${
            !open ? "top-[-400px]" : "top-[0px] py-10"
          }`}
        >
